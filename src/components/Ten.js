      ...
      <View style={styles.feedWrapper}>
          ...
          <View style={styles.postHeaderLeft}>
            ...
            <View style={styles.userInfo}>
              ...
              <View style={styles.dateAndReadTimeWrapper}>
                ...
                <Text style={styles.readTimeText}>1 min read</Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.postImageContainer}>
          <View style={styles.postImage}>
            <Ionicons name="image-outline" size={65} color={colors.ovals} />
          </View>
        </View>
        ...
        <View style={styles.postTextWrapper}>
          <Text style={styles.postTextText}>{postsData[0].Text}</Text>
        </View>
